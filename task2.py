...
def widgets():
    ...
    browsebutton= Button(root , text="browse", command=browse, width=5,bg="#07f246")
    browsebutton.grid(row=2,column=2,padx=4,pady=4)

    downloadbutton=Button(root, text="download video", command= downloadvideo , width=35,bg="#07f246")
